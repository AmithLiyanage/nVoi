...
public class OreoNotification extends ContextWrapper {
    ...
    private static final String CHANNEL_ID = "com.nvoi.nvoi_new";
    private static final String CHANNELNAME = "nvoi_new";
    ...
    public OreoNotification(Context base) {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O){ //English  Capital O
            createChannel();
        }
    }
